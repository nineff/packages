...
- `image-matrix()` function to apply matrix transformations
- `image-info()` function tho get dimensions and format of an image
- `plg.decode()` function to get the raw byte data of an image
